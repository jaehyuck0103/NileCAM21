...
# init camera
~/video-app/src/release/sxpf-init-sequence /dev/sxpf0 -port 0 -ini conf/conf.ini --execute 0
...
~/video-app/src/release/sxpfi2c -f0 0 0 0x84 0 0x43 0x11 0x00 0x0b 0x0b
sleep 0.1
~/video-app/src/release/sxpfi2c -f0 0 0 0x84 0 0x43 0x11 0x00 0x0d 0x00 0x9a 0x09 0x29 0x01 0x00 0x00 0x00 0x01 0xb7
...
~/video-app/src/release/sxpfi2c -f0 0 0 0x84 0 0x43 0x11 0x00 0x0b 0x0b
sleep 0.1
~/video-app/src/release/sxpfi2c -f0 0 0 0x84 0 0x43 0x11 0x00 0x0c 0x00 0x9a 0x09 0x28 0x01 0x00 0x00 0x00 0x01 0xb7
...
~/video-app/src/release/sxpfi2c -f0 0 0 0x84 0 0x43 0x11 0x00 0x0b 0x0b
sleep 0.1
~/video-app/src/release/sxpfi2c -f0 0 0 0x84 0 0x43 0x11 0x00 0x04 0x00 0x98 0x09 0x15 0x01 0x00 0x00 0x00 0x01 0x80
