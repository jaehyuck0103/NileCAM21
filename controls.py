...
# NileCAM FW: 11NL21GMSLXXX0111047a06ceXXXXXXX
controls = {
    ...
    "frame_sync": Control([0x00, 0x10], [0x00, 0x9A, 0x09, 0x2A], 0x01, 0, 1),
    "denoise": Control([0x00, 0x12], [0x00, 0x9A, 0x09, 0x2D], 0x01, 0, 1),
}

# NileCAM FW: 11NL20GMSLXXX01110d20fcb5XXXXXXX
controls_bak = {
    "brightness": Control([0x00, 0x00], [0x00, 0x98, 0x09, 0x00], 0x01, 1, 5),
    "contrast": Control([0x00, 0x01], [0x00, 0x98, 0x09, 0x01], 0x01, 1, 10),
    "saturation": Control([0x00, 0x02], [0x00, 0x98, 0x09, 0x02], 0x01, 0, 10),
